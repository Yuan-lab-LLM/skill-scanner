    ...
    *,
    ...
    def _record_failure(name: str, exc: Exception) -> None:
        if analyzer_failures is not None:
            analyzer_failures.append({"name": name, "error": str(exc)})
    ...
    if use_behavioral:
        try:
            ...
            _record_failure("behavioral", exc)
    ...
    if use_virustotal:
        try:
            ...
            _record_failure("virustotal", exc)
