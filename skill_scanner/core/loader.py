...
class SkillLoader:
    ...
    def load_skill(
        ...
        *,
        ...
        if skill_md_path.exists():
            ...
            manifest, instruction_body, parse_warnings = self._parse_skill_md(skill_md_path, lenient=lenient)
            load_warnings.extend(parse_warnings)
        elif lenient:
            ...
            load_warnings.append("SKILL.md not found; synthesized skill metadata from markdown files")
        else:
    ...
    def _parse_skill_md(self, skill_md_path: Path, *, lenient: bool = False) -> tuple[SkillManifest, str, list[str]]:
        """
        ...
        if "name" not in metadata:
            if lenient:
                ...
                warnings.append("SKILL.md missing required field: name")
            else:
        ...
        if "description" not in metadata:
            if lenient:
                ...
                warnings.append("SKILL.md missing required field: description")
            else:
